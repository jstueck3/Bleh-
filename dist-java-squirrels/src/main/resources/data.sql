insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating, behavior)
values(1, 'Ratufa macroura', 'Grizzled giant squirrel', 'Sri Lanka', 'ggs.jpg', 3, 'Evil');

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating, behavior)
values (2, 'Petaurista philippensis', 'Indian giant flying squirrel', 'India and China', 'igfs.jpg', 6, 'Friendly');

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating, behavior)
values (3, 'Pteromys momonga', 'Japanese dwarf flying squirrel', 'Japan', 'jdfs.jpg',5, 'Evil');

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating, behavior)
values (4, 'Petaurista petaurista', 'Red giant flying squirrel', 'Southeast Asia', 'grfs.jpg',9, 'friendly');

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating, behavior)
values (5, 'Callosciurus prevostii', 'Prevost''s squirrel', 'Thai-Malay Peninsula', 'ps.jpg',7, 'Evil');

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating, behavior )
values (6, 'Ratufa indica', 'Malabar giant squirrel', 'India', 'mgs.jpg',15, 'Good');

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating, behavior)
values (7, 'Mr. fluff', 'The non-existent one ', 'OuterSpace', 'download.jpg',18, 'Evil');
...
insert into location(location_id, name, country)
values (10, 'forest', 'middle of nowhere');
